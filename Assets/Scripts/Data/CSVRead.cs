...
namespace Game
{
    public class CSVRead : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // filename = Application.dataPath + "/Excel/" + "/���б�.csv";
            // ReadCSV();
        ...
        private void WriteCSV()
        {
            ...
            //     else
            //     {
            //         Text name1 = GameObject.Find("����-����").GetComponent<CocktailName>().Word;
            //         string names = name1.text;
            //         float weight1 = size;
            //         Drink newDrink = new Drink();
            //         newDrink.name = names;
            //         newDrink.weight = weight1;
            //         newDrink.num1 = GameObject.Find("��������-��").GetComponent<ML>().text;
            //         newDrink.num2 = GameObject.Find("��������-��").GetComponent<MLblue>().text;
            //         newDrink.num3 = GameObject.Find("��������-��").GetComponent<ML3>().text;
            //         newDrink.num4 = GameObject.Find("��������-ˮ").GetComponent<ML4>().text;
            //         newDrink.num5 = 0;
            //         newDrink.num6 = 0;
            //         newDrink.num7 = 0;
            //         newDrink.num8 = 0;
            ...
            //
            //         tw.WriteLine(names + "," + weight1 + "," + GameObject.Find("��������-��").GetComponent<ML>().text +
            //                      ","
            //                      + GameObject.Find("��������-��").GetComponent<MLblue>().text + "," +
            //                      GameObject.Find("��������-��").GetComponent<ML3>().text + ","
            //                      + GameObject.Find("��������-ˮ").GetComponent<ML4>().text + "," + 0 + "," + 0 + "," +
            //                      0 + "," + 0 + "," + 0 + "," + 0);
            //
            //         tw.Close();
            //
            //         newRowData =  {
            //             number1, name1, weight1, num11, num12, num13, num14, num15, num16, num17, num18, num19, num101
            //         }
            //         Debug.Log("�������");
            //         DestroyObjects();
        ...
        {
            // GameObject[] cocktails = GameObject.FindGameObjectsWithTag(tagToDestroy);
